...
@Component
public class Dtspb5112CloseExistingExpiredRollbackMigrationHandler
    extends AbstractDtspb5112CloseRollbackMigrationHandler {

    public Dtspb5112CloseExistingExpiredRollbackMigrationHandler(
        ...
        super(elasticSearchHandler, config, queries, support, rollbackSupport);
    }

    @Override
    String rollbackId() {
        return Dtspb5112Constants.S4_ROLLBACK_ID;
    }

    @Override
    String migrationDescription() {
        return Dtspb5112CloseExistingExpiredMigrationHandler.DESCRIPTION;
    }

    @Override
    String rollbackSummary() {
        return "DTSPB-5112 - Rollback existing expired caveat closure";
    }

    @Override
    String rollbackDescription() {
        return "Rollback DTSPB-5112 existing expired caveat closure";
    }
}
