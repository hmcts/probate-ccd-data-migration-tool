...
public class Dtspb5130MigrationHandler implements MigrationHandler {
    ...
    static final String MIGRATION_SUMMARY = "DTSPB-5130 - HSE marker from No to Yes";
    static final String MIGRATION_DESCRIPTION = "HSE marker from No to Yes";
    ...
    public Set<CaseSummary> getCandidateCases(
        ...
        final Set<CaseSummary> gorCandidates = elasticSearchHandler.searchCases(
                ...
                fR -> elasticQueries.getGorMigrationQuery(config.getQuerySize()));
    ...
    public boolean shouldMigrateCase(
        ...
        if (hasApplOrgPolicy) {
            log.info("DTSPB-5130: {} case {} already has applicantOrganisationPolicy so no migration needed",
                    caseSummary.type(),
                    caseSummary.reference());
        }
