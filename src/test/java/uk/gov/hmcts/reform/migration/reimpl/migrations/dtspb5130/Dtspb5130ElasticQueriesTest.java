...
class Dtspb5130ElasticQueriesTest {
    Dtspb5130ElasticQueries dtspb5130ElasticQueries;
    ...
    void setUp() {
        ...
        this.dtspb5130ElasticQueries = new Dtspb5130ElasticQueries(elasticSearchQueryUtils);
    }
    ...
    void baseGorMigration() {
        ...
        final JSONObject actual = dtspb5130ElasticQueries.getGorMigrationQuery(
                size,
                fromReference);
    ...
    void baseGorRollback() {
        ...
        final Optional<Long> fromReference = Optional.empty();
        final JSONObject actual = dtspb5130ElasticQueries.getGorRollbackQuery(
                size,
                migrationDate,
                fromReference);
