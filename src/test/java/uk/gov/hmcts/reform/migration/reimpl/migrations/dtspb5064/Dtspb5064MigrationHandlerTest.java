...
class Dtspb5064MigrationHandlerTest {
    ...
    void getCandidateCasesCallsElasticSearchOnce() {
        ...
        assertAll(
            ...
            () -> assertThat(candidateCases, contains(caveatCase)));
    }
    ...
    @Test
    void shouldMigrateCaseWhenStateCaseNotMatched() {
        final MigrationEvent migrationEvent = mock();
    ...
    @Test
    void shouldNotMigrateCaseWhenStateCaseMatching() {
        final MigrationEvent migrationEvent = mock();
    ...
    @Test
    void migrateCaseCaseNotMatchedAndCallsCcdSubmit() {
        final CaseSummary caseSummary = mock();
