...
class Dtspb5064ElasticQueriesTest {
    ...
    @BeforeEach
    void setUp() {
        this.dtspb5064ElasticQueries = new Dtspb5064ElasticQueries();
    }
    ...
    void addSizeThrowsIfNullSize() {
        ...
        assertThrows(NullPointerException.class, () -> dtspb5064ElasticQueries.addSize(empty, size));
    }
    ...
    void addSizeThrowsIfZeroSize() {
        ...
        assertThrows(IllegalArgumentException.class, () -> dtspb5064ElasticQueries.addSize(empty, size));
    }
    ...
    void addSizeAddsSize() {
        ...
        final JSONObject result = dtspb5064ElasticQueries.addSize(empty, size);
    ...
    void addSearchAfterThrowsIfNullFromReference() {
        ...
        assertThrows(NullPointerException.class, () -> dtspb5064ElasticQueries.addSearchAfter(empty, fromReference));
    }
    ...
    void addSearchAfterDoesNothingIfEmptyFromReference() {
        ...
        final JSONObject result = dtspb5064ElasticQueries.addSearchAfter(empty, fromReference);
    ...
    void addSearchAfterAddsSearchAfterArrayFromReference() {
        ...
        final JSONObject actual = dtspb5064ElasticQueries.addSearchAfter(empty, fromReference);
    ...
    void addLastModifiedFilterThrowsIfNullDate() {
        ...
        assertThrows(NullPointerException.class, () -> dtspb5064ElasticQueries.addLastModifiedFilter(
                empty,
                migrationDate));
    }
    ...
    void addLastModifiedFilterAddsLastModifiedFilter() {
        ...
        final JSONObject result = dtspb5064ElasticQueries.addLastModifiedFilter(rollbackQuery, migrationDate);
