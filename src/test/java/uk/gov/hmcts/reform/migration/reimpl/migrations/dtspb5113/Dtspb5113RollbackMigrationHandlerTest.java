...
import uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113Config;
import uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113ElasticQueries;
...
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.GRANT_ISSUED_DATE;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.GRANT_OF_REPRESENTATION;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.JURISDICTION;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.MIGRATION_EVENT;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.ROLLBACK_DESCRIPTION;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.ROLLBACK_ID;
import static uk.gov.hmcts.reform.migration.reimpl.migrations.dtspb5113.Dtspb5113RollbackMigrationHandler.ROLLBACK_SUMMARY;

class Dtspb5113RollbackMigrationHandlerTest {
    @Mock
    ...
    Dtspb5113RollbackMigrationHandler dtspb5113RollbackMigrationHandler;
    ...
    void setUp() {
        ...
        dtspb5113RollbackMigrationHandler = new Dtspb5113RollbackMigrationHandler(
                coreCaseDataApiMock,
                caseEventsApiMock,
    ...
    void getCandidateCasesCallsElasticSearchOnce() {
        ...
        when(reimplConfigMock.getCaseReferences())
                .thenReturn(Optional.of(Set.of(gorCase)));

        final Set<CaseSummary> candidateCases = dtspb5113RollbackMigrationHandler.getCandidateCases(
                userToken,
                s2sToken);

        assertAll(
                () -> verify(reimplConfigMock).getCaseReferences(),
    ...
    void startGorEvent() {
        ...
        final MigrationEvent actual = dtspb5113RollbackMigrationHandler.startEventForCase(
                caseSummary,
                userToken,
                s2sToken);
    ...
    void shouldMigrateCaseNullDetailsThrows() {
        ...
        assertThrows(
                Dtspb5113RollbackMigrationHandler.Dtspb5113RollbackException.class,
                () -> dtspb5113RollbackMigrationHandler.shouldMigrateCase(migrationEvent));
    }
    ...
    @Test
    void shouldMigrateCaseNoGrantIssuedDateDataReturnsFalse() {
        final MigrationEvent migrationEvent = mock();
        ...
        final boolean actual = dtspb5113RollbackMigrationHandler.shouldMigrateCase(migrationEvent);

        assertThat(actual, equalTo(false));
    }

    @Test
    void shouldMigrateCaseGrantIssuedDateInDataNoCaseEventsReturnsFalse() {
        final CaseSummary caseSummary = mock();
    ...
    void shouldMigrateCasePaAdoptedInDataMatchingCaseEventReturnsTrue() {
        ...
        when(caseEventDetail.getDescription())
                .thenReturn(Dtspb5113MigrationHandler.MIGRATION_DESCRIPTION);
        when(caseEventsApiMock.findEventDetailsForCase(any(), any(), any(), any(), any(), any()))
    ...
    void migrateShouldShortCircuitOnDryRun() {
        ...
        final boolean actual = dtspb5113RollbackMigrationHandler.migrate(migrationEvent);
